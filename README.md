...
| skip                  | The custom text for the `Skip` button                                                                                | ReactNode                                   |          | Skip                                                          |
| showPreviousBtn       | Whether or not to display the previous button                                                                        | bool                                     |          | false                                                          |
| showSkipBtn           | Whether or not to display the skip button                                                                            | bool                                     |          | false                                                         |
